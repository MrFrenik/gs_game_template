...
GS_API_DECL void gs_meta_register_generated(gs_meta_registry_t* meta)
{
	...
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_ctor)), (void*)obj_ctor_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_new)), (void*)obj_new_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_dtor)), (void*)obj_dtor_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_serialize)), (void*)obj_serialize_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_deserialize)), (void*)obj_deserialize_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_on_create)), (void*)obj_on_create_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_on_start)), (void*)obj_on_start_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_on_stop)), (void*)obj_on_stop_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_on_update)), (void*)obj_on_update_3141622024);
	gs_hash_table_insert(component_rotation_t_vt.funcs, gs_hash_str64(gs_to_str(gs_obj_on_destroy)), (void*)obj_on_destroy_3141622024);
...
GS_API_DECL component_rotation_t obj_ctor_3141622024(float rotation_speed, gs_vec3 rotation_axis)
{
	...
	cast(this, gs_object_t)->cls_id = gs_obj_sid(component_rotation_t);
	{
            gs_println("CTOR");
...
GS_API_DECL gs_object_t* obj_new_3141622024(float rotation_speed, gs_vec3 rotation_axis)
{
...
GS_API_DECL void obj_dtor_3141622024(gs_object_t* obj)
{
...
GS_API_DECL gs_result obj_serialize_3141622024(gs_byte_buffer_t* buffer, const gs_object_t* in)
{
...
GS_API_DECL gs_result obj_deserialize_3141622024(gs_byte_buffer_t* buffer, gs_object_t* out)
{
...
GS_API_DECL void obj_on_create_3141622024(gs_object_t* obj)
{
	component_rotation_t* this = (component_rotation_t*)obj;
	{ 
...
GS_API_DECL void obj_on_start_3141622024(gs_object_t* obj)
{
}

GS_API_DECL void obj_on_stop_3141622024(gs_object_t* obj)
{
}

GS_API_DECL void obj_on_update_3141622024(gs_object_t* obj)
{
	component_rotation_t* this = (component_rotation_t*)obj;
	{ 
...
GS_API_DECL void obj_on_destroy_3141622024(gs_object_t* obj)
{
}
